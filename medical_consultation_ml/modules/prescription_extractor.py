...
class PrescriptionExtractor:
    ...
    def extract_medicines(self, text: str) -> List[str]:
        ...
        common_suffixes = r'\b([A-Z][a-z]+(?:cillin|mycin|cycline|oxacin|azole|prazole|dipine|olol|pril|sartan|statin|formin))\b'
        medicines.extend(re.findall(common_suffixes, text))
        
        # Pattern 2: Medicine with dosage (e.g., "Amoxicillin 500mg")
        medicine_with_dose = r'\b([A-Z][a-z]+)\s+\d+\s*(?:mg|g|ml|mcg)\b'
        ...
        for med in medicines:
            ...
            if med_clean and med_clean.lower() not in seen:
    ...
    def extract_prescription_details(self, text: str, medicine: str) -> Dict[str, any]:
        ...
        instruction_keywords = ['before', 'after', 'with', 'without', 'take', 'apply']
